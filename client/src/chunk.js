...
export class Chunk {
    ...
    draw() {
        ...
        const water_image = texture.load('https://raw.githubusercontent.com/RishavMz/3D_Battle_Arena/main/client/resources/water.png');
        const sand_image = texture.load('https://raw.githubusercontent.com/RishavMz/3D_Battle_Arena/main/client/resources/sand.png');
        ...
        this.texture === 100? sand_image.repeat.set(64, 64) : sand_image.repeat.set(8, 8);
        ...
        this.texture === 100? water_image.repeat.set(64, 64) : water_image.repeat.set(8, 8);
        ...
        const water = new THREE.Mesh(new THREE.PlaneBufferGeometry(2048, 2048), new THREE.MeshBasicMaterial({map: water_image, transparent: true, opacity: 0.4}));
        const sand = new THREE.Mesh(new THREE.PlaneBufferGeometry(2048, 2048), new THREE.MeshBasicMaterial({map: sand_image}));
